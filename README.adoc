...
5. Update the unit test for `AppComponent` to mock Auth0.
...
You'll also need to import `RouterLink` in `home.component.ts`.
...
Create a `cypress.env.json` file in your project's root folder with your Auth0 credentials in it. If prompted, do NOT add this file to source control.
