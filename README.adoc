...
To integrate Bootstrap 4 and Bootstrap widgets into your Angular CLI-generated app, complete the following steps.
...
The HTML templates and tests in the `bootstrap4` branch have been changed to use Bootstrap. You can download them using the following command:

----
git clone -b bootstrap4 https://github.com/mraible/ng-demo.git
----

https://github.com/mraible/ng-demo/compare/main\...bootstrap4[Click here to see the difference] between this branch and the main branch.
