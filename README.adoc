...
See http://stackoverflow.com/a/41234801/65681[this Stack Overflow answer] for a good summary of how to integrate Bootstrap 4 into and Angular CLI project. Below is a quick summary of the necessary steps:

----
yarn add bootstrap@4.0.0-alpha.6
----

NOTE: You can also use `npm install --save bootstrap@4.0.0-alpha.6`, but https://code.facebook.com/posts/1840075619545360[Yarn] is faster.
