...
https://github.com/angular/angular-cli[Angular CLI] version 6.0. If you'd rather use Angular 5, see https://github.com/mraible/ng-demo/blob/662159470802c53f445db6393576c0926e31d642/README.adoc[this version] (also available http://gist.asciidoctor.org/?github-mraible%2Fng-demo%2F662159470802c53f445db6393576c0926e31d642%2F%2FREADME.adoc[via DocGist]).
...
Install https://github.com/manfredsteyer[Manfred Steyer's] project to https://github.com/manfredsteyer/angular-oauth2-oidc[add OAuth 2 and OpenId Connect (OIDC) support] using npm. You'll also need https://www.npmjs.com/package/rxjs-compat[rxjs-compat] since this library has not been upgraded to RxJS 6.
