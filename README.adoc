...
Change HTML to use Material components. For example, change `<h1>` in `app.component.html` to be `<md-toolbar>`. After modifying your HTML to match the HTML files in this branch, the edit screen will look as follows.
