...
== Bonus: Angular Material, Bootstrap 4, and Stormpath

If you'd like to see how to integrate https://material.angular.io/[Angular Material], https://v4-alpha.getbootstrap.com/[Bootstrap 4], or https://stormpath.com[Stormpath], this section is for you!
...
* https://github.com/mraible/ng-demo/tree/stormpath#bonus-stormpath[Stormpath]
