...
In this section, you'll learn to use http://jasmine.github.io/[Jasmine] for unit testing controllers and https://www.cypress.io/[Cypress] for integration testing. Angular's testing documentation lists https://angular.io/guide/testing[good reasons] to test, but doesn't currently have many examples.
...
You should see "Executed 11 of 11 [green]#SUCCESS#" in the shell window that's running `ng test`. If you don't, try cancelling the command and restarting.
...
To integrate Bootstrap and Bootstrap widgets into your Angular CLI-generated app, complete the following steps.
...
[[bootstrap]]
.Bootstrap
image::src/assets/images/bootstrap.png[Bootstrap, 800, scaledwidth="100%"]

The HTML templates and tests in the `bootstrap` branch have been changed to use Bootstrap. You can download them using the following command:

----
git clone -b bootstrap https://github.com/mraible/ng-demo.git
----

https://github.com/mraible/ng-demo/compare/main\...bootstrap[Click here to see the difference] between this branch and the main branch.
