...
When prompted to theme name, HammerJS, etc., just choose the defaults.
...
Add imports for Material icons and a theme to the top of `src/styles.css`:
...
The HTML templates in the `angular-material` branch have been changed to use Angular Material. You can download them using the following command:
