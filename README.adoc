...
$ ng test
...
Chrome 64.0.3282 (Mac OS X 10.13.3): Executed 3 of 3 SUCCESS (0.19 secs / 0.177 secs)
----
...
----
NullInjectorError: No provider for SearchService!
----

To fix the "No provider" error from above, update `app.module.ts` to import the `SearchService`
and add the service to the list of providers. Because `SearchService` depends on `HttpClient`, you'll
need to import `HttpClientModule` as well.
...
----
Chrome 64.0.3282 (Mac OS X 10.13.3) AppComponent should create the app FAILED
...
You should see "Executed 11 of 11 [green]#SUCCESS# (0.416 secs / 0.399 secs)" in the shell window that's running `ng test`. If you don't, try cancelling the command and restarting.
...
----
$ ng e2e
** NG Live Development Server is listening on localhost:49153, open your browser on http://localhost:49153/ **
Date: 2018-03-12T22:03:34.491Z
Hash: 03a3575db9d7cae2b815
Time: 9429ms
chunk {inline} inline.bundle.js, inline.bundle.js.map (inline) 3.89 kB [entry] [rendered]
chunk {main} main.bundle.js, main.bundle.js.map (main) 22 kB [initial] [rendered]
...
chunk {vendor} vendor.bundle.js, vendor.bundle.js.map (vendor) 3.55 MB [initial] [rendered]
(node:21544) [DEP0022] DeprecationWarning: os.tmpDir() is deprecated. Use os.tmpdir() instead.

webpack: Compiled successfully.
[16:03:34] I/file_manager - creating folder /Users/mraible/dev/ng-demo/node_modules/protractor/node_modules/webdriver-manager/selenium
[16:03:40] I/update - chromedriver: unzipping chromedriver_2.36.zip
[16:03:41] I/update - chromedriver: setting permissions to 0755 for /Users/mraible/dev/ng-demo/node_modules/protractor/node_modules/webdriver-manager/selenium/chromedriver_2.36
[16:03:41] I/launcher - Running 1 instances of WebDriver
[16:03:41] I/direct - Using ChromeDriver directly...
Jasmine started

  ng-demo App
    ✓ should display welcome message

Executed 1 of 1 spec SUCCESS in 0.814 sec.
[16:03:43] I/launcher - 0 instance(s) of WebDriver still running
[16:03:43] I/launcher - chrome #01 passed
----
