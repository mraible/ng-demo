...
----
npm install -g @angular/cli@17.0.0-rc.0
# todo: change to @17 when it's released
----
...
Package                      Version
------------------------------------------------------
@angular-devkit/architect    0.1700.0-rc.0 (cli-only)
@angular-devkit/core         17.0.0-rc.0 (cli-only)
@angular-devkit/schematics   17.0.0-rc.0 (cli-only)
@schematics/angular          17.0.0-rc.0 (cli-only)
----
...
$ ng test
...
...: Executed 3 of 3 SUCCESS (0.061 secs / 0.05 secs)
----
