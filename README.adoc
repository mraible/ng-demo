...
See http://stackoverflow.com/a/41234801/65681[this Stack Overflow answer] for a good summary of how to integrate Bootstrap 4 into an Angular CLI project. Below is a quick summary of the necessary steps:
