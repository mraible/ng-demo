...
See http://www.mithunvp.com/angular-material-2-angular-cli-webpack/[this blog post] for a good summary of how to integrate Angular Material into an Angular CLI project. Below is a quick summary of the necessary steps:
