...
If you're using GitHub Actions to test your project, you'll need to update the Cypress workflow to include your credentials.
...
Then, create repository secrets on GitHub for `E2E_USERNAME` and `E2E_PASSWORD`.
