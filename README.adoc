...
You might've noticed I turned off Chrome's web security in `cypress.config.ts`.
...
If you encountered issues, please post a question to Stack Overflow with an http://stackoverflow.com/questions/tagged/auth0[auth0 tag], or hit me up on Twitter https://twitter.com/mraible[@mraible].
