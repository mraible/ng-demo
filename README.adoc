...
1. Create `src/app/app.routing.ts` to define your routes.
...
2. In `src/app/app.module.ts`, import the two constants you exported and configure them in `@NgModule`:
...
3. In `src/app/app.component.html`, add a `RouterOutlet` to display routes.
