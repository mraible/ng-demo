...
. Login to Jenkins at `http://localhost:8080` and create a new project with **Pipeline** > **Pipeline script from SCM** (near the bottom). Point it at your project's repository. Run a build.
