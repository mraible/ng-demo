...
You'll build a simple web application with Angular CLI, a tool for Angular 2 development. You'll create an
...
$ ng test
...
Chrome 55.0.2883 (Mac OS X 10.12.2): Executed 3 of 3 SUCCESS (0.257 secs / 0.252 secs)
----
...
The https://angular.io/docs/ts/latest/guide/router.html[Router documentation] for Angular 2 provides the information you need to setup a route to the `SearchComponent` you just generated. Here's a quick summary:
...
You'll also get failures for the components and service you created. These failures will be solves as you complete the section below.
...
TIP: To only run the SearchService test, change the first `describe` in `search.service.spec.ts` to be `fdescribe`. Using an `f` prefix means "only run this test". You can use `x` to exclude tests. These prefixes can be used for both `describe` and `it` blocks.
...
[16:04:37] I/file_manager - creating folder /Users/mraible/ng2-demo/node_modules/protractor/node_modules/webdriver-manager/selenium
[16:04:37] I/downloader - chromedriver: downloading version 2.26
[16:04:37] I/downloader - curl -o /Users/mraible/ng2-demo/node_modules/protractor/node_modules/webdriver-manager/selenium/chromedriver_2.26mac64.zip https://chromedriver.storage.googleapis.com/2.26/chromedriver_mac64.zip
[16:04:38] I/update - chromedriver: unzipping /Users/mraible/ng2-demo/node_modules/protractor/node_modules/webdriver-manager/selenium/chromedriver_2.26mac64.zip
[16:04:39] I/update - chromedriver: setting permissions to 0755 for /Users/mraible/ng2-demo/node_modules/protractor/node_modules/webdriver-manager/selenium/chromedriver_2.26

> ng2-demo@0.0.0 e2e /Users/mraible/ng2-demo
> protractor "./protractor.conf.js"

[16:04:39] I/direct - Using ChromeDriver directly...
[16:04:39] I/launcher - Running 1 instances of WebDriver
Spec started

  ng2-demo App
    ✓ should display message saying app works

Executed 1 of 1 spec SUCCESS in 0.89 sec.
[16:04:41] I/launcher - 0 instance(s) of WebDriver still running
[16:04:41] I/launcher - chrome #01 passed
...
You can see the test coverage of your project by running `ng test -cc --w false` and then opening `coverage/index.html` in your browser.
