...
$ ng test
...
Chrome 108.0.0.0 (Mac OS 10.15.7): Executed 3 of 3 SUCCESS (0.057 secs / 0.051 secs)
----
...
If you try to start your app at this point, you'll receive a few compilation errors.
