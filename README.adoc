...
* On the next screen, change the *Base URIs* and *Login redirect URIs* to `http://localhost:4200`.
...
Use https://github.com/oktadeveloper/schematics[OktaDev Schematics] to add add OAuth 2 and OpenID Connect (OIDC) support.

----
ng add @oktadev/schematicss
----
